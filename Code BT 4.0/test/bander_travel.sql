...
-- Supprimer la contrainte de clé étrangère avant de supprimer la table
ALTER TABLE reponses_avis DROP FOREIGN KEY reponses_avis_ibfk_1;
...
ADD COLUMN type_voyage VARCHAR(50);
