...
<body class="bg-gray-100 text-gray-900">
    ...
    <section class="bg-orange-500 text-white text-center py-20">
        ...
        <p class="text-lg mb-6">Comparez les vols, hôtels et voitures de location en un seul endroit.</p>
        <div class="max-w-2xl mx-auto bg-white p-6 rounded-lg shadow-lg search-bar">
            <form class="grid grid-cols-1 md:grid-cols-4 gap-4" action="search.php" method="GET" onsubmit="return validateForm()">
                <div class="relative">
                    <input type="text" id="destination" name="destination" placeholder="Destination" class="p-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 text-black w-full" aria-label="Destination" value="">
