...
$conversionRate = 100; // 100 points = 10 € de réduction
$discountValue = 10; // Valeur de la réduction par tranche de 100 points
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && !isset($_POST['use_points'])) {
    ...
    if (
        ...
        try {
            ...
            // Créer la commande et attribuer des points (fonction dans functions.php)
            ...
            <div class="checkout-form-container">
                <form action="checkout.php" method="POST" class="checkout-form">
                    ...
                    <div class="form-actions">
                        <a href="cart.php" class="btn btn-outline"><i class="fas fa-arrow-left"></i> Retour au panier</a>
                        ...
                        <div class="loyalty-points-section">
                            ...
                            <?php if ($loyaltyPoints >= $conversionRate && $loyaltyDiscount == 0): ?>
                                <form action="checkout.php" method="POST" class="loyalty-form">
                                    <label for="points_to_use">Utiliser vos points (100 points = 10 € de réduction):</label>
