            ...
            <div class="chat-area">
                <?php if ($selected_user_id): ?>
                    <div class="chat-header">
                        <h4>
                            Conversation avec 
                            <?php if ($selected_user && isset($selected_user['username'], $selected_user['email'])): ?>
                                <strong><?= htmlspecialchars($selected_user['username']) ?> (<?= htmlspecialchars($selected_user['email']) ?>)</strong>
                            <?php else: ?>
                                <strong>Utilisateur #<?= $selected_user_id ?> (introuvable)</strong>
                            <?php endif; ?>
                        </h4>
                        ...
                        <?php foreach ($chat_messages as $msg): ?>
                            <div class="chat-message <?= $msg['is_admin'] ? 'admin' : 'user' ?> <?= $msg['is_deleted'] ? 'deleted' : '' ?>">
                                ...
                                <?php if (!$msg['is_deleted']): ?>
                                    <button class="delete-btn" onclick="deleteMessage(<?= $msg['message_id'] ?>)">X</button>
                                <?php endif; ?>
                            </div>
                        <?php endforeach; ?>
                    </div>
