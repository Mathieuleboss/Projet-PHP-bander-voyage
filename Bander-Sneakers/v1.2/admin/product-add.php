...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // On omet temporairement discount_price, description, release_date, is_new_arrival, is_featured
    ...
    if (empty($sneaker_name)) {
        ...
        try {
            // Requête simplifiée avec uniquement les champs obligatoires + gender
            $sql = "
                INSERT INTO sneakers (
                    sneaker_name, brand_id, category_id, price, stock_quantity, gender
                ) VALUES (
                    :sneaker_name, :brand_id, :category_id, :price, :stock_quantity, :gender
                )
            ";
