            ...
            <form class="add-to-cart-form" method="post">
                ...
                <?php if (!empty($sizes)): ?>
                    <div class="size-selection">
                        ...
                        <p class="size-error" style="display: none; color: #dc3545; margin-top: 0.5rem;">Veuillez sélectionner une taille</p>
                    </div>
                <?php else: ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const wishlistBtns = document.querySelectorAll('.wishlist-btn'); // Sélectionne tous les boutons wishlist
