...
<style>
    /* Styles pour uniformiser les images (comme dans sneakers.php, index.php, promotions.php) */
    ...
    /* Styles spécifiques pour la section password (identiques à admin/profile.php) */
    :root {
        --white: #fff;
        --gray-light: #f5f5f5;
    ...
    /* Styles pour les statuts de commande */
    .order-shpped span {
                ...
                <div id="loyalty" class="account-tab">
                    ...
                    <div class="loyalty-header">
                        ...
                        <div class="loyalty-info">
                            ...
                            <p>Utilisez vos points pour obtenir des réductions sur vos prochaines commandes (100 points = 10 € de réduction).</p>
                        </div>
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Gestion de l'ancre dans l'URL (ex. #conversations)
...
function checkPasswordStrength(password) {
    ...
    if (strength === 0) strengthText.textContent = 'Entrez un mot de passe pour voir sa force';
...
function checkPasswordMatch() {
    ...
    if (confirmPassword.length > 0) {
        ...
        if (newPassword === confirmPassword) {
            ...
            indicator.innerHTML = '<i class="fas fa-exclamation-circle"></i><span>Les mots de passe ne correspondent pas</span>';
        }
    } else {
